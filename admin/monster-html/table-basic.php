            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Patient List</h3>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Click delete to delete patients account</h6>
                                            ...
                                            <?php
                                                ...
                                                if ($check > 0) {
                                                    while ($rows = mysqli_fetch_assoc($result)) {
                                                        echo "<tr>";
                                                            echo "<td>" . $rows['usersId'] . "</td>";
                                                            echo "<td>" . $rows['usersName'] . "</td>";
                                                            echo "<td>" . $rows['usersUsername'] . "</td>";
                                                            echo "<td>" . $rows['usersEmail'] . "</td>";
                                                            echo "<td>" . $rows['phoneNumber'] . "</td>";
                                                            echo "<td><a href='../../includes/delete-account.inc.php?id=$rows[usersId]'>Delete</a></td>";
                                                        echo "</tr>";
                                                    }
                                                }
                                            ?>
